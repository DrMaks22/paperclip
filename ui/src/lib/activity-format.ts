...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  "instance.settings.issue_graph_liveness_auto_recovery_run": "stableCore.issueGraphLivenessAutoRecoveryRun",
  "issue.blockers.updated": "localizationActivityEvents.issue_blockers_updated",
  "issue.harness_liveness_escalation_created": "stableCore.harnessLivenessEscalationCreated",
