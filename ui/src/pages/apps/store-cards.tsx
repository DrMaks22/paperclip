  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="text-sm font-semibold text-foreground">{t("localizationConnections.connectYourOwnTool18")}</div>
        <div className="text-xs text-muted-foreground">
          {t("stableApps.store.byoDescription")}
        </div>
      </div>
      <span className="shrink-0 text-xs font-semibold text-primary">{t("pages.apps.browse.connectAction")}</span>
    </button>
  );
}
