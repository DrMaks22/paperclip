                  ...
                  <table className="w-full min-w-(--sz-40rem) text-sm">
                    <thead>
                      <tr className="border-b border-border bg-muted/40 text-left text-(length:--text-micro) font-semibold uppercase tracking-wide text-muted-foreground">
                        <th className="px-4 py-2.5">{t("localizationApps.gateway316")}</th>
                        <th className="px-4 py-2.5">{t("localizationSkills.scope118")}</th>
                        <th className="px-4 py-2.5">{t("nav.apps")}</th>
                        <th className="px-4 py-2.5">{t("pages.userProfile.tokens")}</th>
                        <th className="px-4 py-2.5">{t("pages.apps.connections.columnLastUsed")}</th>
                        <th className="px-4 py-2.5 text-right">{t("pages.instanceSettings.on")}</th>
                      </tr>
                    </thead>
                    <tbody>
