...
const state = vi.hoisted(() => ({ companyId: null as string | null, setBreadcrumbs: vi.fn(), list: vi.fn() }));
...
describe("MyIssues localization", () => {
  ...
  it("preserves stable organization wording and updates breadcrumbs", async () => {
    await render();
    expect(container.textContent).toContain("Select an organization to view your tasks.");
