...
export function PasteConfigTab({ companyId }: { companyId: string }) {
  ...
  return (
    <div className="space-y-5">
      <p className="max-w-2xl text-sm text-muted-foreground">{t("localizationTools.pasteTheMCPConfigSnippetFromTheToolSREADMEAnd355")}</p>
    ...
    <div className="space-y-4 border-t border-border pt-5">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">{t("stableApps.pasteConfig.checked")}</p>
        </div>
