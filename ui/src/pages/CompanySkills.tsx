...
const SOURCE_FILTER_LABELS: Record<SourceFilter, string> = {
  ...
  get company() { return t("localizationSkills.organization21"); },
...
function skillSettingsToastBody(skill: Pick<CompanySkillDetail, "categories" | "sharingScope">) {
  const sharing = skill.sharingScope === "private" ? t("localizationSkills.sharingPrivate58") : t("localizationSkills.sharingOrganization59");
      ...
      {step === 0 ? (
        ...
        <div className="space-y-4 text-sm">
          <div className="grid grid-cols-(--gtc-26) gap-y-2">
            ...
            <span>{draft.sharingScope === "private" ? t("localizationSkills.private119") : t("localizationSkills.organization21")}</span>
        ...
        <div className="space-y-4 text-sm">
          ...
          {defaultAction === "install" ? (
            <div className="rounded-md border border-border p-3">
              ...
              <p className="mb-2 text-xs text-muted-foreground">{t("localizationSkills.installingAddsTheSkillToTheOrganization180")}</p>
              <AgentMultiSelect
                agents={agents}
                ...
                emptyMessage={t("localizationSkills.noAgentsInThisOrganizationSupportSkills181")}
...
function AttachAgentsPopover({
  ...
  return (
    <AgentMultiSelect
      ...
      emptyMessage={eligible.length === 0 ? t("localizationSkills.noAgentsInThisOrganizationSupportSkills181") : t("localizationSkills.noAgentsYet192")}
      isAgentDisabled={(agent) => {
        const option = agent as AttachAgentOption;
        return option.required || !option.supportsSkills;
      }}
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              >
                <option value="company">{t("localizationSkills.organizationVisibleInsideThisOrganization270")}</option>
            ...
            {detail.editable ? (
              <div className="rounded-md border border-destructive/40 p-3">
                ...
                <div className="mt-2 flex items-center justify-between gap-3">
                  <p className="min-w-0 text-xs text-muted-foreground">{t("localizationSkills.removeThisSkillFromTheOrganizationLibrary275")}</p>
                  <Button
                    variant="destructive"
                    size="sm"
                    className="shrink-0"
...
export function CompanySkills() {
  ...
  const deleteSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: t("localizationSkills.skillRemovedFromOrganization", { name: skill.name }),
      });
    },
    onError: (error) => {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Boxes} message={t("localizationSkills.selectAnOrganizationToManageSkills377")} />;
  }
  ...
  const studioDescription = studioForkFromId
    ? t("localizationSkills.reviewTheForkMetadataAndCreateAn379")
    : t("localizationSkills.createAnEditableOrganizationSkillInThe380");
  return (
    <>
      {policyDenial.denial ? (
      ...
      <Dialog open={deleteOpen} onOpenChange={closeDeleteDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>{t("localizationSkills.removeThisSkillFromTheOrganizationLibrary382")}</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={importDialogOpen} onOpenChange={setImportDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>{t("localizationSkills.pasteALocalPathGitHubURLOr394")}</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
