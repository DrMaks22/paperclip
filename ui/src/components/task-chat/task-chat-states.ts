...
export const TASK_CHAT_STATE_META: Record<TaskChatStateId, TaskChatStateMeta> = {
  ...
  "agent-message": {
    id: "agent-message",
    get label() { return t("stableTaskChat.agentMessage"); },
    tier: "live",
    surface: "thread",
  ...
  responding: {
    id: "responding",
    get label() { return t("localizationTaskRuntime.display.ui_Responding_streaming_1pt4bkt"); },
    tier: "live",
    surface: "thread",
  ...
  "responding-burst": {
    id: "responding-burst",
    get label() { return t("stableTaskChat.respondingBurst"); },
    tier: "live",
    surface: "thread",
