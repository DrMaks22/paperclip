...
export function TaskChatLiveRunPill({
  ...
  const elapsed = elapsedMs != null ? taskChatDurationLabel(formatDurationWords(elapsedMs) ?? "") : null;
  const verb = active ? t("localizationTaskRuntime.ui_Working_1pyssg8") : t("localizationTaskRuntime.worked");
