...
const PROJECT_SORT_CHOICES: SidebarSectionRadioChoice[] = [
  { value: "top", get "label"() { return t("nav.sort.top"); } },
  { value: "alphabetical", get "label"() { return t("nav.sort.alphabetical"); } },
  { value: "recent", get "label"() { return t("nav.sort.recent"); } },
];
...
export function SidebarProjects() {
  ...
  const projectSortChoices: SidebarSectionRadioChoice[] = PROJECT_SORT_CHOICES.map((choice) => ({
    ...choice,
    label: t(`nav.sort.${choice.value}`),
  }));
  ...
  return (
    <SidebarSection
      ...
      menu={{
        ariaLabel: t("nav.projectsSectionActions"),
        actions: [
          { type: "item", label: t("nav.browseProjects"), icon: FolderOpen, href: "/projects" },
          { type: "separator" },
        ],
        radioLabel: t("nav.sortProjects"),
