    ...
    <div className="border-t border-r border-border bg-background px-3 py-2">
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent
          ...
          align="start"
          sideOffset={10}
          className="w-(--sz-277px) max-w-(--sz-calc-24) max-h-(--radix-popover-content-available-height) overflow-x-hidden overflow-y-auto rounded-t-2xl rounded-b-none border-border p-0 shadow-2xl"
        >
