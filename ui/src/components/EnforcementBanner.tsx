  ...
  return (
    <div className={cn(enforcementBanner({ variant }), className)} role="status">
      ...
      <div className="min-w-0 flex-1">
        {variant === "denied-detected" ? (
          <p>
            <Trans i18nKey="stableCore.deniedCalls" count={computedCount} components={{ count: <span className="font-medium" /> }} />
          </p>
        ) : (
          <p>
            {t("localizationFinalChrome.serverEnforcement")}
          </p>
        )}
      </div>
      <Link
